...
class RelativeDockingUtilities {
    ...
    */
    ...
    public static int findAnchors(Component base, Container ancestorContainer) {
        int contact = AnchorConstraints.ANCHOR_TOP
    ...
    public static SingleDockableContainer insertDockable(
        ...
        if (relativeAncestorContainer.getComponentCount() == 0) { // empty docking panel
            ...
            if (split != null) {
                ...
                Point leftCenter = SwingUtilities.convertPoint(
                        left, left.getWidth() / 2, left.getHeight() / 2, relativeAncestorContainer);
                Point rightCenter = SwingUtilities.convertPoint(
                    ...
                    if (anchoredTop) {
                        ...
                        if (anchoredRight) { // 2005/10/10
                            ...
                            if (bestComp == top) {
                                ...
                                newSplit.setBottomComponent((Component) dockableContainer);
                                SwingUtilities.invokeLater(new SplitResizer(
    ...
    public static DockingActionEvent getInsertionDockingAction(
        ...
        if (relativeAncestorContainer.getComponentCount() == 0) { // empty docking panel
            ...
            if (split != null) {
                // ok we've found one
                Rectangle splitRect = SwingUtilities.convertRectangle(
                        split, new Rectangle(0, 0, split.getWidth(), split.getHeight()), relativeAncestorContainer);
