...
/**
 * Interface implemented by classes that need to be notified of a state change of a dockable before it is
 * processed.
 * <p>
 ...
 * </ul>
 * <p>
 * Those event are vetoable : invoking their <code>cancel</code> method will stop the state change processing.
 *
 *
