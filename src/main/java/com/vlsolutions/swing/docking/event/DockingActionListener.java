...
public interface DockingActionListener {
    ...
    /**
     * Invoked before a docking action is processed, to give a chance to the listener to react to it and
     * cancel it if needed.
     *
     ...
     *
     * @param event
     *            the event corresponding to the docking action. Subclasses of DockingActionEvent are used to
