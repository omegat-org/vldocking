...
/**
 * An abstract factory used by the <code>DockingDesktop</code> to create instance of Dockable containers.
 * <p>
 * This factory enables API Extenders to change part of the behaviour on the DockingDesktop (mostly about look
 * and feel issues) without modifying the code of that central class.
 *
...
public abstract class DockableContainerFactory {
     ...
     * <p>
     * This method is used by the standard implementation of Docking (DockView, etc) but is optional for other
     * implementations, as currently the titlebar isn't specified as a core component of the docking framework
     * (i.e. it is not an interface).
     * 
     * @since 2.1.3
     */
