 ...
 * <p>
 * Depending on the orientation of the layout, the two integers majorOrder and minorOrder express the opposite
 * measures :
 * <ul>
 ...
 * </ul>
 * <p>
 * Example : To layout two toolbars horizontally on an horizontal layout, use the following constraints (0,0)
 * and (0,1) (the column is the minor order on an horizontal layout).
 * <p>
 * to layout them in a row (one above the other), use the constraints (0,0) and (1,0) (the row is the major
 * order on an horizontal layout).
 *
...
public class ToolBarConstraints {
    ...
    /**
     * Set to -1/0/+1 during drag/drop phase to allow insertion between rows/columns. Do not use it outside
     * drag and drop operations.
     */
    /* package protected */ int majorOffset = 0;

    /**
     * Set to -1/0-31 during drag/drop phase to allow insertion between rows/columns Do not use it outside
     * drag and drop operations.
     */
